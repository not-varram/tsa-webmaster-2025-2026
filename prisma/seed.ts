...
async function main() {
	...
	const chapters = await Promise.all([
		prisma.chapter.create({
			data: {
				...
				city: 'Kirkland',
				region: 'King County',
				about: 'The TSA Chapter @ Lake Washington HS, Founded in 2025.',
				latitude: 47.7062,
				longitude: -122.1857,
		...
		prisma.chapter.create({
			data: {
				...
				city: 'Redmond',
				region: 'King County',
				about: 'The TSA Chapter @ Tesla STEM HS.',
				latitude: 47.6848,
				longitude: -122.0932,
		...
		prisma.chapter.create({
			data: {
				...
				city: 'Redmond',
				region: 'King County',
				about: 'The TSA Chapter @ Redmond HS.',
				latitude: 47.6740,
				longitude: -122.1215,
	...
	const resources = await Promise.all([
		prisma.resource.create({
			data: {
				...
				origin: 'WTSA',
				highlighted: true,
				url: 'https://www.washingtontsa.org/start-a-chapter',
			},
		}),
		prisma.resource.create({
			data: {
				...
				origin: 'WTSA',
				highlighted: true,
				url: 'https://www.washingtontsa.org/leadership-resources',
			},
		}),
		prisma.resource.create({
			data: {
				...
				url: 'https://docs.google.com/document/d/1li1B3i_MR1x3nUi6RttsxZZNnmS1-MOjGNHABKM70Vk/edit?usp=sharing',
			},
		}),
		prisma.resource.create({
			data: {
				...
				origin: 'CHAPTER',
				chapterId: chapters[1].id,
				url: 'https://docs.google.com/document/d/1iPAPd9iMIgbNPCcFrmRpD0Qhwk6RqAcXB90JfDIw44I/edit?usp=sharing',
			},
		}),
	])
	...
	const events = await Promise.all([
		...
		prisma.event.create({
			data: {
				slug: 'regional-robotics-meetup-1',
				title: 'Regional Robotics Meetup #1',
        ...
        prisma.event.create({
			data: {
				slug: 'regional-robotics-meetup-2',
				title: 'Regional Robotics Meetup #2',
				description: 'Bring your robots and run practice matches with other chapters in the region.',
				startDatetime: new Date('2026-03-08T10:00:00'),
				endDatetime: new Date('2026-03-08T15:00:00'),
				type: 'Meetup',
				audience: ['Students'],
				location: 'Lake Washington High School, Kirkland',
			},
		}),
	])
