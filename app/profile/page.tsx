...
export default function ProfilePage() {
	...
	const getRoleBadge = () => {
		switch (user.role) {
			...
			case 'STUDENT':
				return <span className="px-2 py-1 bg-neutral-100 text-neutral-800 rounded-full text-xs font-medium">Student</span>
			default:
				return null
		}
	}
	...
	return (
		<div className="min-h-[calc(100vh-4rem)] py-8">
			<div className="container mx-auto px-4 max-w-2xl">
				<h1 className="text-3xl font-bold text-neutral-900 mb-8">Your Profile</h1>

				{/* Profile Info Card */}
				<div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 mb-6">
					<div className="flex items-start gap-4">
						<div className="w-16 h-16 rounded-full bg-primary-600 flex items-center justify-center text-white font-bold text-2xl">
							...
							{isEditingName ? (
								<form onSubmit={handleNameUpdate} className="flex items-center gap-2 mb-2">
									<input
										...
										className="text-xl font-semibold text-neutral-900 px-2 py-1 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
										autoFocus
									/>
									<button
										type="submit"
							...
							<div>
								...
								<div className="flex items-center gap-2">
									<input
										...
										value={user.name}
										disabled
										className="flex-1 px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-600"
									/>
									<button
										onClick={() => {
											setNewName(user.name)
								...
								<p className="text-xs text-neutral-500 mt-1">This name is visible to other users</p>
							</div>
							<div>
								...
								<input
									...
									value={user.email}
									disabled
									className="w-full px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-600"
								/>
								<p className="text-xs text-neutral-500 mt-1">Contact your chapter admin to change your email</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div className="bg-white rounded-xl shadow-sm border border-neutral-200 overflow-hidden mb-6">
					<div className="px-6 py-4 border-b border-neutral-200">
						...
						<p className="text-sm text-neutral-600">Track your resource requests and offerings (including fulfilled ones)</p>
					</div>
					<MyPostsList />
				</div>
